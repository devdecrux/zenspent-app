    ...
    <div class="px-6 py-4 mx-auto">
      <div class="lg:flex lg:items-center">
        <div class="flex items-center justify-between">
          ...
          <img class="w-1/4 lg:w-1/2 lg:mx-auto" src="../assets/logo.png" alt="zenspent"/>
        ...
        <div :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 flex-1 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center lg:justify-between">
          <div class="flex flex-col text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
            <RouterLink to="/dashboard" class="mt-2 transition-colors duration-300 transform lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200" @click="isOpen = false">Dashboard</RouterLink>
