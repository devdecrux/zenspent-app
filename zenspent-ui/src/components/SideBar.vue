...
<template>
  <aside
    class="hidden lg:flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700"
  >
    <a href="#">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
      <nav>
        ...
        >
          ...
          <RouterLink to="/dashboard" class="mx-4 font-medium">Dashboard</RouterLink>
        </a>
        ...
        >
          ...
          <RouterLink to="/transactions" class="mx-4 font-medium">Transactions</RouterLink>
        </a>
        ...
        >
          ...
          <RouterLink to="/subscriptions" class="mx-4 font-medium">Subscriptions</RouterLink>
        </a>
        ...
        >
          ...
          <RouterLink to="/settings" class="mx-4 font-medium">Settings</RouterLink>
        </a>
      </nav>
